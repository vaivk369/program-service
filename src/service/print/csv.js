...
async function renderMCQ(
  ...
  let data = {
    ...
    Option2: questionOptions.length > 1 ? questionOptions[1][0] : "",
    Option3: questionOptions.length > 2 ? questionOptions[2][0] : "",
    Option4: questionOptions.length > 3 ? questionOptions[3][0] : "",
